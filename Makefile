...
test-sm:
	@echo "Testing Module ./sm"
	@cd sm && go test ./... -coverprofile=../coverage-sm.out -covermode=atomic
...
.PHONY: test test-all test-api test-db test-idx test-sm test-coverage test-clean
