...
require (
	...
	github.com/choraio/server/state v0.0.0
...
require (
	...
	github.com/choraio/server/db v0.1.0-alpha1 // indirect
	...
	github.com/regen-network/regen-ledger/x/data/v2 v2.0.0 // indirect
