...
psql postgres://postgres:password@localhost:5432/postgres -f migrations/001_init.sql

# seed database with data from chora genesis state (geonode metadata)
psql postgres://postgres:password@localhost:5432/postgres -c "INSERT INTO data (iri, jsonld) VALUES (
